...
def main(limit):
    ...
    for lowest_number in xrange(1, lowest_number_limit):
        maximum_multiple_limit = highest_number_limit / lowest_number**2
        for highest_number, lowest_to_highest_factor in [
                ...
                for maximum_multiple in xrange(1, maximum_multiple_limit)]:
            # Find middle_number,
